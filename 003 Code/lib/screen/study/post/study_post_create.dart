...
class StudyPostCreatePage extends StatefulWidget {
  @override
  State<StudyPostCreatePage> createState() => _StudyPostCreatePageState();
  String selectedTab;
  String studyId;

  StudyPostCreatePage({this.selectedTab = '게시판을 선택하세요', required this.studyId});
}

class _StudyPostCreatePageState extends State<StudyPostCreatePage> {
  ...
  Future<void> getImage(ImageSource imageSource) async {
    ...
    setState(() {
      ...
      imageCount = images.length; // 리스트의 길이로 직접 업데이트
    });
  }
        ...
        return Container(
          child: ListView.builder(
            ...
            itemBuilder: (context, index) {
              return ListTile(
                trailing: widget.selectedTab == boardName[index]
                ...
                onTap: () {
                  setState(() {
                    ...
                    widget.selectedTab = boardName[index];
                  });
                  Get.back();
                },
              );
  ...
  Widget build(BuildContext context) {
    return Scaffold(
                        ...
                        child: Stack(
                          ...
                          children: [
                            ...
                            Positioned(
                              ...
                              child: GestureDetector(
                                onTap: () {
                                  _removeImage(index); // 이미지 삭제 함수 호출
                                },
                                child: Container(
      ...
      bottomNavigationBar: GestureDetector(
        onTap: () async {
          if (widget.selectedTab == '게시판을 선택하세요') {
          ...
          if (!isSubmitting) {
            ...
            try {
              ...
              FirebaseFirestore.instance.collection('studyPostInfo');
