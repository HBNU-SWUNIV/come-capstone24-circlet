...
class RecommendStudyPage extends StatefulWidget{
  @override
  State<RecommendStudyPage> createState() => _RecommendStudyPage();
...
class _RecommendStudyPage extends State<RecommendStudyPage>{
  ...
  Widget build(BuildContext context) {
    return Scaffold(
        appBar: AppBar(
          title: Text('이런 스터디도 있어요', style: f22bw700),
        ),
        body: SingleChildScrollView(
          child: ListView.builder(
            shrinkWrap: true,
            physics: NeverScrollableScrollPhysics(),
            itemCount: ss.otherStudyList.length,
            itemBuilder: (context, index) {
              var isLiked = ss.otherStudyList[index]['likeList']
                  .contains(us.userList[0]['docId']);
              return Padding(
                padding: EdgeInsets.only(top: 17),
                child: GestureDetector(
                  onTap: () {
                    List list = ss.otherStudyList.value;
                    ss.studyList.clear();
                                  ...
                                  children: [
                                    CachedNetworkImage(
                                      ...
                                      'https://firebasestorage.googleapis.com/v0/b/circlet-9c202.appspot.com/o/studyImage%2F${ss
                                          .otherStudyList[index]['docId']}?alt=media',
                                      fit: BoxFit.cover,
                                    ...
                                    Positioned(
                                        ...
                                        child: GestureDetector(
                                          onTap: () async {
                                            await toggleLike(ss
                                                .otherStudyList[index]['docId'],
                                                isLiked);
                                            setState(() {
                                              if (isLiked) {
                                                ss.otherStudyList[index]['likeList']
                        ...
                        Expanded(
                          child: Column(
                            ...
                            children: [
                              Wrap(
                                  children:
                                  ss.otherStudyList[index]['interest']
                                      .map<Widget>(
                                          (interests) {
                              ...
                              Padding(
                                ...
                                child: Row(
                                  children: [
                                    Text(
                                        '${ss
                                            .otherStudyList[index]['sido']} ${ss
                                            .otherStudyList[index]['gungu']}',
                                        style: f10w400DeppGray),
                                    Spacer(),
                                    Text(
                                        '멤버 ${ss
                                            .otherStudyList[index]['studyUserList']
                                            .length}',
                                        style: f10w400DeppGray),
                                    Spacer(),
                                    Text(
                                        '좋아요 ${(ss
                                            .otherStudyList[index]['likeList'] as List)
                                            .length}',
                                        style: f10w400DeppGray),
                                  ],
                                ),
