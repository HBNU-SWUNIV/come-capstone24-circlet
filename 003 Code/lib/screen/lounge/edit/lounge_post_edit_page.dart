...
class LoungePostEditPage extends StatefulWidget {
  final Map<String, dynamic> postInfo;

  LoungePostEditPage({required this.postInfo});

  @override
  State<LoungePostEditPage> createState() => _LoungePostEditPageState();
}

class _LoungePostEditPageState extends State<LoungePostEditPage> {
              ...
              child: Container(
                child: Row(
                  children: [
                    Padding(
                      padding:
                      const EdgeInsets.only(left: 16, top: 30, bottom: 12),
                      child: Text(
                        postCategory,
                        style: f16bw500,
                      ),
        ...
        onTap: () async {
          if (!isSubmitting) {
            ...
            try {
              ...
              allImagePaths = [...existingImageUrls, ...newImagePaths];
              await _updatePost();
            } catch (e) {}
            setState(() {
              isSubmitting = false;
